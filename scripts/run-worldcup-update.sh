...
5) `node scripts/notify-telegram.mjs "..."`로 갱신 요약을 보낸다. 메시지에는 주요 결과(특히 한국 경기)와 글 주소 https://blog-x84m.vercel.app/blog/2026-world-cup-tracker/ 를 포함한다.
