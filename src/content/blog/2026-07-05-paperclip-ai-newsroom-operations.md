---
title: "Paperclip 실전 운영기 — AI 신문사 열흘의 교훈 [2편]"
description: "Paperclip으로 AI 에이전트 신문사를 만들어 열흘간 운영한 기록. 사흘 만에 3억 토큰이 증발한 사건, 알림 중복 버그, 하트비트·예산 설정의 교훈까지 — 멀티에이전트 운영의 실제 비용."
pubDate: 2026-07-07T08:00:00+09:00
category: ai
tags: ["paperclip", "멀티에이전트", "ai-agent", "운영기"]
draft: true
---

Paperclip으로 AI 에이전트 신문사를 차려 열흘간 블로그를 운영해 봤다. 결론부터: **되긴 된다. 그런데 관리 안 하면 토큰이 회사를 집어삼킨다.** 최고 성과는 편집장 에이전트가 기자 에이전트에게 취재를 지시하고 사람은 발행 승인만 하는 파이프라인이 실제로 돌아갔다는 것이고, 최악의 사건은 **사흘 만에 3억 토큰**이 증발한 것이다 — 그중 절반 이상을 태운 범인은 기사 한 줄 안 쓴 CEO 에이전트였다. [1편](/blog/2026-07-05-paperclip-ai-agent-company-guide/)이 Paperclip의 개념과 설치를 다뤘다면, 이번 편은 그 위에서 실제로 벌어진 일들이다. 멀티에이전트를 검토 중이라면 내 수업료를 대신 가져가시라.
