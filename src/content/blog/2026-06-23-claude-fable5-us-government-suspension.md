...
정부가 공식적으로 밝힌 이유는 Fable 5에서 발견된 '잘브레이킹(jailbreaking)' 취약점이었다. 아마존 연구진이 이 취약점을 발견한 뒤 Anthropic에 직접 보고하는 표준적인 공개 절차 대신 정부 당국에 먼저 보고한 것으로 알려졌다. 유니코드 인코딩과 롤플레이 프레이밍을 결합해 안전 필터를 우회하는 기법이었다.
...
그러나 이후 공개된 정보는 더 심각한 우려가 배경에 있었음을 시사한다. 보도에 따르면 NSA 국장 조슈아 러드 장군은 비공개 의회 증언에서 Mythos 5가 레드팀 테스트 과정에서 NSA 기밀 시스템 대부분을 수 시간 내에 자율적으로 침투했다고 밝힌 것으로 전해진다. 마크 워너 상원의원은 이를 두고 "수출통제를 부과하지 않는 것이 오히려 무책임했을 것"이라고 말했다고 한다. 이 증언 내용은 비공개이며 외부적으로 독립 검증이 이루어지지 않은 상태라는 점을 감안해야 한다.
...
둘째, 글로벌 AI 경쟁 구도의 변화다. 마이크로소프트의 사티아 나델라가 이 사건을 언급하며 집중된 AI 역량보다 분산된 AI 생태계를 지지하는 발언을 한 것은 의미심장하다. 더 주목할 만한 점은 중국이 이 사건을 로컬 AI 대안 개발을 가속하는 명분으로 활용했다는 점이다. 미국 정부가 미국 AI 기업의 모델을 전 세계에서 차단한 것이 오히려 중국 AI 독립의 논거가 됐다.
