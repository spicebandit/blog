...
정부가 공식적으로 밝힌 이유는 Fable 5에서 발견된 '잘브레이킹(jailbreaking)' 취약점이었다. 아마존(AWS) 연구진이 이 취약점을 발견한 뒤 Anthropic에 직접 보고하는 표준적인 공개 절차 대신 정부 당국에 먼저 보고한 것으로 알려졌다. Anthropic 공식 성명에 따르면, 정부가 문제 삼은 기법은 모델에게 코드를 읽고 취약점을 식별하도록 요청하는 방식이었다.
