...
updatedDate: 2026-07-12T13:15:00+09:00
category: life
...
<span class="wc-updated">🔄 마지막 업데이트: 2026년 7월 12일 오후 1시 15분 (KST)</span>
...
<tr><td>현재 단계</td><td><b>4강(준결승) 4팀 확정 — 아르헨티나가 스위스를 3-1(연장)로 꺾고 마지막 4강 티켓을 거머쥐었다.</b> 알렉시스 맥알리스터가 전반 10분 선제골을 넣었으나 단 은도예에게 후반 67분 동점골을 허용했고, 스위스 브렐 엠볼로가 72분 경고 누적 퇴장을 당한 뒤 <b>연장에서 훌리안 알바레스(112분)·라우타로 마르티네스(120+1분)가 연속골</b>을 터뜨려 승부를 갈랐다(2회 연속 4강). 이로써 4강 대진이 모두 확정됐다: <b>'프랑스 vs 스페인'(7/15 04:00 KST·댈러스)</b>, <b>'잉글랜드 vs 아르헨티나'(7/16 04:00 KST·애틀랜타)</b>. 앞선 8강에서 <b>프랑스가 모로코를 2-0(음바페·뎀벨레), 스페인이 벨기에를 2-1(파비안 루이스·메리노 결승골), 잉글랜드가 노르웨이를 2-1(연장, 벨링엄 멀티골)</b>로 눌렀다. 16강에서는 <b>모로코가 캐나다를 3-0, 프랑스가 파라과이를 1-0, 노르웨이가 브라질을 2-1</b>(브라질 36년 만의 첫 16강 탈락), <b>잉글랜드가 멕시코를 3-2, 스페인이 포르투갈을 1-0</b>(호날두 탈락), <b>벨기에가 미국을 4-1</b>로 꺾었고, <b>아르헨티나는 이집트에 0-2로 뒤지다 3-2 대역전승</b>, <b>스위스는 콜롬비아와 0-0 뒤 승부차기 4-3</b>으로 이겼다. <b>대한민국은 조별리그 A조 3위(각 조 3위 10위)로 32강 진출이 무산돼 대회를 마쳤다.</b></td></tr>
...
<p class="wc-note">데이터 출처: FIFA·ESPN·NBC Sports·Yahoo Sports·FOX Sports 등 공개 자료(2026-07-12 오후 1시 15분 기준). 본 페이지는 경기 종료 후 자동 갱신됩니다. 결과가 불확실한 항목은 확정 후 반영됩니다.</p>
