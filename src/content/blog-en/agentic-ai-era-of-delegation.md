---
title: "Agentic AI: The Era of Delegation Has Arrived"
...
## Why Agentic AI Is Different: The Subject of Innovation Switches
...
- **Understand the goal**: interpret what the user wants
- **Plan**: design the steps to reach that goal independently
- **Use tools**: call on external tools and data as needed
- **Verify**: check whether the output actually meets the goal
- **Execute**: complete the task — booking, payment, processing — end to end
...
How this delegation plays out concretely in markets is explored in [Part 2: How Agentic AI Reshapes Markets](/en/blog/how-agentic-ai-reshapes-markets/). How it works inside organizations is covered in [Part 3: Agentic AI and Organizational Transformation](/en/blog/agentic-ai-organizational-transformation/).
